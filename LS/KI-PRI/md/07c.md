...
- projekt, který obsahuje kód, kterému dobře rozumíte (pozor
  na AI generovaný kód, ten musíte prostudovat, porozumět mu
...
- Server (backend): Docker/Linux/Apache:
  ...
  _(Pokud nelze jinak, můžete použít i jiné, podobné
  prostředí, např. XAMPP, nicméně prostředí Docker/Linux je
  preferováno.)_
