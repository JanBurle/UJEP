...
také proto, že celý webový „ekosystém“ je poznamenán svým bouřlivým vývojem a s ním
...
Pokud nemá XML soubor příslušnou informaci o stylu, zobrazí jej prohlížeč jako stromovou
strukturu.

- [`3 - cdcatalog.php`](../Pracovní%20projekt/www/html/3%20-%20cdcatalog.php)
...
a příslušném adresáři vytvořte odpovídající CSS soubor.

- [`cdcatalog.xml`](../Pracovní%20projekt/www/html/xml/CDs/cdcatalog.css)
- [`cdcatalog.css`](../Pracovní%20projekt/www/html/xml/CDs/cdcatalog.css)
...
- [`cdcatalog.xsl`](../Pracovní%20projekt/www/html/xml/CDs/cdcatalog.xsl)

Zobrazte výsledek. Styl upravte a doplňte podle potřeby.

- [`cdcatalog.xml`](../Pracovní%20projekt/www/html/xml/CDs/cdcatalog.xml)
- [`3 - cdcatalog.php`](../Pracovní%20projekt/www/html/3%20-%20cdcatalog.php)
...
- [`4 - cdcatalog.php`](../Pracovní%20projekt/www/html/4%20-%20cdcatalog.php)

## Transformace XML/XSL client-side

- [`5 - cdcatalog.php`](../Pracovní%20projekt/www/html/5%20-%20cdcatalog.php)
...
V praxi se pro stylování používají moderních CSS knihovny (frameworks). V úvahu přicházejí,
mimo jiné:
...
Pokud stylujete jen pomocí "vanilla" CSS, je vhodné nejdříve vložit např.
[normalize.css](https://necolas.github.io/normalize.css/).

Pro stylování v příkladech je použito [W3.CSS](https://www.w3schools.com/w3css/) a
