...
* [`SimpleXML/simplexml-load-string.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-load-string.php)
...
* [`SimpleXML/simplexml-iterate1.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-iterate1.php)

Pokud znáte strukturu vašeho SimpleXML (soubor XML je validní), můžete přímo přistoupit k jeho částem:

* [`SimpleXML/simplexml-iterate2.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-iterate2.php)

Můžete také použít [xpath](https://www.php.net/manual/en/simplexmlelement.xpath.php):

* [`SimpleXML/simplexml-iterate3.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-iterate3.php)
...
* [`SimpleXML/simplexml-create.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-create.php)

Pokud chcete, aby XML text obsahoval styl, použijte:

* [`SimpleXML/simplexml-create-xsl.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-create-xsl.php)
...
* [`SimpleXML/simplexml-create-db.php`](../Projekt%20-%20work/www/html/SimpleXML/simplexml-create-db.php)
