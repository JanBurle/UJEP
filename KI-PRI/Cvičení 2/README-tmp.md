...
Dnes se seznámíte s tvorbou komplexních XML Schémat pomocí jazyka XML.

### Předchozí cvičení:

V minulém cvičení jste:
* Nainstalovali vývojové prostředí (Docker kontejner s LAMP, VSCode) a zprovoznili jednoduchou webovou stránku, která ověřuje, zda nahraný XML soubor je dobře strukturovaný (well-formed), případně soubor validuje pomocí nahraného DTD souboru.
* Seznámili jste se s jazykem XML: s jeho elementy (značkami), atributy a jmennými prostory.
...
* Navrhli jste strukturu XML dokumentů pro záznam informací o studentech a fakultě.
...
### ❖ Úkol 2.1: RSS
Prozkoumejte strukturu nějakého RSS zdroje (*RSS feed*), jako je např. [https://news.bitcoin.com/feed](https://news.bitcoin.com/feed/). Mnoho RSS zdrojů najdete na [rss.feedspot.com](https://rss.feedspot.com/) nebo [podle návodu](https://rss.app/blog/the-ultimate-guide-to-rss-feeds-in-2022-Rrxcde).
