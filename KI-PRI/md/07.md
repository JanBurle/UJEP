...
V adresáři [`./www/xml`](../ProjectXML3/www/xml) naleznete ukázkové soubory `fakulta.*`. Pro
stylování transformovaného HTML je použito [W3.CSS](https://www.w3schools.com/w3css/) a
