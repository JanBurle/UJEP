...
final class Recept extends Clanek implements I\SessionZapisovatelne, I\XMLZapisovatelne
{
    ...
    */
    ...
    function get_obtiznost()
    {
        return $this->_obtiznost;
    }
    function get_ingredience()
    {
        return $this->_ingredience;
    }
    function get_postup()
    {
        return $this->_postup;
    ...
    function set_nazev($value)
    {
        $this->_nazev = $value;
    }
    function set_puvod($value)
    {
        $this->_puvod = $value;
    }
    function set_cas($value)
    {
        $this->_cas = $value;
    }
    function set_obtiznost($value)
    {
        $this->_obtiznost = $value;
    }
    function set_ingredience($value)
    {
        $this->_ingredience = $value;
    }
    function set_postup($value)
    {
        $this->_postup = $value;
    }
