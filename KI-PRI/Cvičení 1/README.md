...
RUN apt update && \
    ...
    apt remove -y libxslt1-dev icu-devtools libicu-dev libxml2-dev && \
    rm -rf /var/lib/apt/lists/*

#instalace rozsireni mysqli pro komunikace s mysql databazi
RUN docker-php-ext-install mysqli && docker-php-ext-enable mysqli
```
Dockerfile je soubor, který slouží dockeru pro vytvoření obrazu, který chceme následně spustit v kontejneru. Zde předložený Dockerfile provede následující:
