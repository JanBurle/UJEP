...
Tento kód je užitečný, můžeme si z něj udělat funkci:
...
Napište program, ve uživatel zadá sadu čísel oddělených čárkou. Následně ve druhém vstupu zvolí slovy jakou operaci chce s čísly provést: např. `sečti`, `vynásob`, atd. nebo `+`, `*` atd. Program podle výběru čísla sečte, vynásobí, atd., a vypíše výsledek.
