...
print(3, slovník.keys())
for key in slovník.keys():
  print(key)

print(4, slovník.values())
for key in slovník.values():
  print(key)

print(5, slovník.items())
for item in slovník.items():
  print(item)

print(6, slovník['dvacet'])
# print(6, slovník['třicet']) # KeyError
print(6, slovník.get('třicet'))
print(6, slovník.get('třicet', 30))

print(7, slovník.get(10))
print(7, slovník.pop(10))
# print(7, slovník.pop(10)) # KeyError
print(7, slovník.get(10))

print(8, 'dvacet' in slovník)
print(8, 10 in slovník)
```
...
Délku souboru lze zjistit také pomocí metody `tell()`:
...
Příznakem `b` je možno pracovat se souborem tzv. binárně, tj. bajt po bajtu:
