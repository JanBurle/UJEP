...
Podmínkou získání zápočtu je úspěšné napsání zápočtového písemného testu, nebo zpracování seminární práce.
...
Námět seminární práci si vymýšlí student sám a schvaluje ji cvičící, nebo jej, v případě zájmu studenta, může zadat přednášející nebo cvičící. Kontrola toho, zda student své práci dostatečně rozumí (dokáže vysvětlit jednotlivé řádky kódu a mentální postup za nimi) proběhne na konzultacích příslušného cvičícího (pokud garant předmětu neurčí jinak).
