...
Při řešení zápočtového testu mophou studenti použít libovolné tištěné materiály. Povoleny ale nejsou jakékoliv elektronické prostředky (tablet, laptop, telefon, chytré hodinky, ...).

Námět seminární práce si vymýšlí student sám a schvaluje ji cvičící, nebo jej, v případě zájmu studenta, může také zadat přednášející nebo cvičící. Kontrola toho, zda student své práci dostatečně rozumí (dokáže vysvětlit jednotlivé řádky kódu a mentální postup za nimi) proběhne na konzultacích příslušného cvičícího (pokud garant předmětu neurčí jinak).
